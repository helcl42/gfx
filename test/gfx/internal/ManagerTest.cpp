...
public:
    ...
    GfxResult bufferMapAsync(GfxBuffer, uint64_t, uint64_t, void**) const override { return GFX_RESULT_SUCCESS; }
    ...
    GfxResult queueWriteTexture(GfxQueue, const GfxWriteTextureDescriptor*, const void*, uint64_t) const override { return GFX_RESULT_SUCCESS; }
